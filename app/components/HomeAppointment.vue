<template>
  <section
    class="relative bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 py-20 lg:py-32 overflow-hidden"
  >
    <!-- Animated background elements -->
    <div
      class="absolute top-0 left-0 w-96 h-96 bg-[#7fc540]/10 rounded-full blur-3xl animate-float"
    />
    <div
      class="absolute bottom-0 right-0 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl animate-float-delayed"
    />
    <div class="absolute inset-0 opacity-5">
      <div
        class="absolute inset-0 bg-[repeating-linear-gradient(45deg,transparent,transparent_10px,rgba(127,197,64,0.3)_10px,rgba(127,197,64,0.3)_20px)]"
      />
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          <div
            class="bg-white/5 backdrop-blur-sm rounded-3xl p-8 md:p-10 shadow-2xl border border-white/10 animate-fade-in-up"
          >
            <form class="space-y-6" @submit.prevent="handleSubmit">
              ...
              <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="group">
                  <label
                    class="block text-white text-sm font-medium mb-2 flex items-center gap-2"
                  >
              ...
              <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="group">
                  ...
                  >
                    ...
                    <option value="Eye Examination" class="text-gray-900">
                      Comprehensive Eye Examination
                    </option>
                    <option value="Cataract Treatment" class="text-gray-900">
                      Cataract Treatment
                    </option>
                    <option value="Glaucoma Management" class="text-gray-900">
                      Glaucoma Management
                    </option>
                    <option value="Vision Correction" class="text-gray-900">
                      Vision Correction
                    </option>
                    <option value="Frames & Lenses" class="text-gray-900">
                      Frames & Lenses Selection
                    </option>
                    <option value="Community Health" class="text-gray-900">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                  ...
                  >
                    <div class="flex items-start gap-3">
                      ...
                      >
                        <div
                          v-if="formData.location === location.name"
                          class="w-2.5 h-2.5 bg-[#7fc540] rounded-full"
                        />
                      </div>
                      <div>
              ...
              <div class="flex items-start gap-3">
                ...
                >
                  ...
                  <a
                    href="/privacy"
                    class="text-[#7fc540] hover:text-[#6ab030] underline"
                    >privacy policy</a
                  >
              ...
              >
                ...
                <div
                  v-if="isFormValid"
                  class="absolute inset-0 bg-gradient-to-r from-[#6ab030] to-[#7fc540] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                />
              </button>
              ...
              <div
                v-if="showSuccess"
                class="p-4 bg-[#7fc540]/20 border border-[#7fc540]/30 rounded-xl flex items-start gap-3 animate-fade-in"
              >
                <UIcon
                  name="i-lucide-check-circle"
                  class="text-[#7fc540] text-xl flex-shrink-0 mt-0.5"
                />
                <div>
        ...
        <div class="lg:col-span-1 space-y-6">
          <!-- Contact Card -->
          <div
            class="bg-white/5 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/10 hover:border-white/20 transition-all duration-300 animate-fade-in-up"
          ...
          >
            ...
            <div class="space-y-4">
              <div class="flex items-start gap-3 group">
                <div
                  class="p-2 bg-[#7fc540]/20 rounded-lg flex-shrink-0 group-hover:bg-[#7fc540]/30 transition-colors"
                >
                  <UIcon
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-400">
                    45-60 minute thorough eye examination
                  </p>
                </div>
              </div>
              <div class="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-400">
                    Personalized care from Dr. Alabegbe
                  </p>
                </div>
              </div>
              <div class="flex items-start gap-3 group">
